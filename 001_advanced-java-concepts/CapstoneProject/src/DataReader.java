        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(filePath))){
            ...
            while((line = reader.readLine())!=null){
                ...
                if (data.length == 5) {
                    ...
                    transactions.add(new Transaction(transactionId, userId, amount, timestamp, location));
                }
            }
            ...
            System.err.println("XƏTA: Məlumatları emal edərkən problem yarandı: " + e.getMessage());
        }
